...
const PIECES: Piece[] = [
  ...
  // T H E  C A V E — one exported vector per letter
  { src: "/images/brand/letters/t.svg", x: 196.7, y: 78.56, w: 47.65, h: 58.81 },
  { src: "/images/brand/letters/h.svg", x: 255.24, y: 78.55, w: 48.65, h: 58.81 },
  { src: "/images/brand/letters/e1.svg", x: 319.0, y: 78.53, w: 43.95, h: 58.81 },
  { src: "/images/brand/letters/c.svg", x: 389.54, y: 77.55, w: 53.69, h: 60.81 },
  { src: "/images/brand/letters/a.svg", x: 449.0, y: 78.13, w: 61.24, h: 59.23 },
  { src: "/images/brand/letters/v.svg", x: 506.89, y: 78.55, w: 57.88, h: 59.23 },
  { src: "/images/brand/letters/e2.svg", x: 574.83, y: 78.53, w: 43.95, h: 58.81 },
];
